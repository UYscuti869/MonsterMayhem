...
public class Arrow : MonoBehaviour
{
    ...
    {
        if (other.gameObject.CompareTag("Enemy") || other.gameObject.CompareTag("Blue Enemy") || other.gameObject.CompareTag("Red Enemy"))
        {
        ...
        if (other.gameObject.CompareTag("Black Enemy"))
        {
            damageAudio.PlayOneShot(damageSound);
            other.GetComponent<HitPoint>().EnemyDamageInput(damage);
            Destroy(gameObject);
